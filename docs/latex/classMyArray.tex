...
pos must be smaller then m\+\_\+size! 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
...
\subsubsection[{\texorpdfstring{operator[](const int index)}{operator[](const int index)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ T \& {\bf My\+Array}$<$ T $>$\+::{\bf operator}\mbox{[}$\,$\mbox{]} (
\begin{DoxyParamCaption}
\item[{const int}]{index}
\end{DoxyParamCaption}
)}\hypertarget{classMyArray_a49f2d5aa8d69d077b1c17f076f097406}{}\label{classMyArray_a49f2d5aa8d69d077b1c17f076f097406}
object getter \mbox{[}\mbox{]}

\begin{DoxyPrecond}{Precondition}
index must be between 0 and m\+\_\+size 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
none 
\end{DoxyPostcond}
